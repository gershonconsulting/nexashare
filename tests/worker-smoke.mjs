...
assert.match(dashboardSource, /EXPECTED_EXTENSION_VERSION\s*=\s*'1\.2\.11'/);
...
assert.match(extensionSetupSource, /Current version 1\.2\.11/);
assert.match(extensionSetupSource, /nexashare-extension-1\.2\.11\.zip/);
