...
assert.match(dashboardSource, /EXPECTED_EXTENSION_VERSION\s*=\s*'1\.2\.10'/);
...
assert.match(extensionSetupSource, /Current version 1\.2\.10/);
assert.match(extensionSetupSource, /nexashare-extension-1\.2\.10\.zip/);
...
assert.match(extensionSource, /repost instantly\\b\|\\breshare instantly/);
