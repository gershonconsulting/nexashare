...
assert.match(dashboardSource, /EXPECTED_EXTENSION_VERSION\s*=\s*'1\.2\.14'/);
...
assert.match(dashboardSource, /Release 1\.2\.15/);
assert.match(dashboardSource, /August 22, 2026/);
...
assert.match(extensionSetupSource, /Current version 1\.2\.14/);
assert.match(extensionSetupSource, /nexashare-extension-1\.2\.14\.zip/);
