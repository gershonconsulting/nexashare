...
assert.match(dashboardSource, /EXPECTED_EXTENSION_VERSION\s*=\s*'1\.2\.5'/);
...
assert.match(dashboardSource, /Original post/);
...
assert.match(extensionSetupSource, /Current version 1\.2\.5/);
