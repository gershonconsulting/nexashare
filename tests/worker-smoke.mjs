...
assert.match(dashboardSource, /EXPECTED_EXTENSION_VERSION\s*=\s*'1\.2\.19'/);
...
assert.match(dashboardSource, /Release 1\.2\.19/);
assert.match(dashboardSource, /September 16, 2026/);
...
assert.match(extensionSetupSource, /Current version 1\.2\.19/);
assert.match(extensionSetupSource, /nexashare-extension-1\.2\.19\.zip/);
...
assert.match(reportSource, /CURRENT_EXTENSION_VERSION = '1\.2\.19'/);
...
assert.match(workerSource, /CURRENT_EXTENSION_VERSION = '1\.2\.19'/);
