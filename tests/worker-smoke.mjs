...
assert.match(dashboardSource, /EXPECTED_EXTENSION_VERSION\s*=\s*'1\.2\.16'/);
...
assert.match(dashboardSource, /Release 1\.2\.16/);
assert.match(dashboardSource, /August 25, 2026/);
...
assert.match(extensionSetupSource, /Current version 1\.2\.16/);
assert.match(extensionSetupSource, /nexashare-extension-1\.2\.16\.zip/);
