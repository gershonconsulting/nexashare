...
assert.match(dashboardSource, /EXPECTED_EXTENSION_VERSION\s*=\s*'1\.2\.18'/);
...
assert.match(dashboardSource, /Release 1\.2\.18/);
assert.match(dashboardSource, /September 9, 2026/);
...
assert.match(extensionSetupSource, /Current version 1\.2\.18/);
assert.match(extensionSetupSource, /nexashare-extension-1\.2\.18\.zip/);
